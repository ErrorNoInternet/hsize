...
'-p+[Number of decimal places to display in the converted number]:PRECISION:_default' \
'--precision=[Number of decimal places to display in the converted number]:PRECISION:_default' \
...
&& ret=0
    ...
    (hsize)
        ...
        case $line[2] in
            (replace)
_arguments "${_arguments_options[@]}" : \
'-r+[Regex to use for matching numbers]:REGEX:_default' \
