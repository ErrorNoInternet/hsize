...
complete -c hsize -n "__fish_seen_subcommand_from generate; and __fish_seen_subcommand_from completions" -s s -l shell -d 'Output completion files for the specified shell' -r -f -a "{bash	'',elvish	'',fish	'',powershell	'',zsh	''}"
